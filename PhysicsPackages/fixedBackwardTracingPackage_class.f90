module backwardTracingPackage_class
  ...
  !!
  type, public, extends(physicsPackage) :: backwardTracingPackage
    private
    ! Components
  ...
  end type backwardTracingPackage
...
contains
  ...
  subroutine init(self,dict)
    class(backwardTracingPackage), intent(inout) :: self
    ...
    character(100), parameter :: Here = 'init (backwardTracingPackage_class.f90)'
  ...
  subroutine initialiseSource(self, dict)
    ...
    character(100), parameter :: Here = 'initialiseSource (backwardTracingPackage_class.f90)'
  ...
  subroutine initialiseRay(self, r)
    ...
    character(100), parameter :: Here = 'initialiseRay (backwardTracingPackage_class.f90)'
  ...
  subroutine uncollidedSweep(self, r, ints)
    class(backwardTracingPackage), target, intent(inout) :: self
    type(ray), intent(inout)                              :: r
    ...
    character(100), parameter :: Here = 'uncollidedSweep (backwardTracingPackage_class.f90)'
...
!!
  ...
  subroutine printSettings(self)
    class(backwardTracingPackage), intent(in) :: self
...
end module backwardTracingPackage_class