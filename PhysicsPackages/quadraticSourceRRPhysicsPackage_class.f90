module quadraticSourceRRPhysicsPackage_class
    ...
    !!   PP {
    !!     type quadraticSourceRRPhysicsPackage;
    ...
    !!
    type, public, extends(physicsPackage) :: quadraticSourceRRPhysicsPackage
      private
      ! Components
    ...
    end type quadraticSourceRRPhysicsPackage
  ...
  contains
    ...
    subroutine init(self,dict)
      class(quadraticSourceRRPhysicsPackage), intent(inout) :: self
      ...
      character(100), parameter :: Here = 'init (quadraticSourceRRPhysicsPackage_class.f90)'
    ...
    subroutine initialiseRay(self, r)
      ...
      character(100), parameter :: Here = 'initialiseRay (quadraticSourceRRPhysicsPackage_class.f90)'
    ...
    subroutine transportSweep(self, r, ints, it)
      class(quadraticSourceRRPhysicsPackage), target, intent(inout) :: self
      type(ray), intent(inout)                              :: r
    ...
    subroutine printSettings(self)
      class(quadraticSourceRRPhysicsPackage), intent(in) :: self
  ...
  end module quadraticSourceRRPhysicsPackage_class
