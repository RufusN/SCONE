module adjointFixedSourcePhysicsPackage_class 
    ...
    !!   PP {
    !!     type adjointFixedSourcePhysicsPackage;
    ...
    !!
    type, public, extends(physicsPackage) :: adjointFixedSourcePhysicsPackage
      private
      ! Components
    ...
    end type adjointFixedSourcePhysicsPackage
  ...
  contains
    ...
    subroutine init(self,dict)
      class(adjointFixedSourcePhysicsPackage), intent(inout) :: self
      ...
      character(100), parameter :: Here = 'init (adjointFixedSourcePhysicsPackage_class.f90)'
    ...
    subroutine initialiseRay(self, r)
      ...
      character(100), parameter :: Here = 'initialiseRay (adjointFixedSourcePhysicsPackage_class.f90)'
    ...
    subroutine transportSweep(self, r, ints)
        class(adjointFixedSourcePhysicsPackage), target, intent(inout) :: self
        type(ray), intent(inout)                              :: r
    ...
    subroutine printSettings(self)
      class(adjointFixedSourcePhysicsPackage), intent(in) :: self
  ...
  end module adjointFixedSourcePhysicsPackage_class
